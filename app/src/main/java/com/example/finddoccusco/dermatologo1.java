...
public class dermatologo1 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dermatologo1);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(dermatologo1.this,derma1.class);
