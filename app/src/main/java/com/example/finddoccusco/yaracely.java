...
public class yaracely extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        this.setTitle("Dr. Wilson Holguin Herrera");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yaracely);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(yaracely.this,ubicacion_docWison.class);
