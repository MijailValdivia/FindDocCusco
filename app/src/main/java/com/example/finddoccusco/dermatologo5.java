...
public class dermatologo5 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dermatologo5);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(dermatologo5.this,derma5.class);
