...
public class endocrinonologo4 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_endocrinonologo4);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(endocrinonologo4.this,endo4.class);
