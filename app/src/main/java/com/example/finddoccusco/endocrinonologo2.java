...
public class endocrinonologo2 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_endocrinonologo2);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(endocrinonologo2.this,endo2.class);
