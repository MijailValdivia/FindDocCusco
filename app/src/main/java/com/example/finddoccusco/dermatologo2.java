...
public class dermatologo2 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dermatologo2);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(dermatologo2.this,derma2.class);
