...
public class SegundoMedicogeneral extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        this.setTitle("Dr. Yaracely Ayqipa Chacon");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_segundo_medicogeneral);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(SegundoMedicogeneral.this,segundomedico.class);
