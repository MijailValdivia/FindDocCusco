...
public class CuartoMedicogeneral extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        this.setTitle("Dr. Paolo Guerrero Suarez");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cuarto_medicogeneral);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(CuartoMedicogeneral.this,medicocuarto.class);
