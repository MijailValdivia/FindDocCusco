...
public class dermatologo4 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dermatologo4);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(dermatologo4.this,derma4.class);
