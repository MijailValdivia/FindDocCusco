...
public class TercerMedicogeneral extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        this.setTitle("Dr. Donny Holguin Herrera");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tercer_medicogeneral);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(TercerMedicogeneral.this,medicotercero.class);
