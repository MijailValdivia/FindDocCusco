...
public class endocrinonologo3 extends AppCompatActivity {
    MediaPlayer mp;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_endocrinonologo3);
    ...
    public void uwilson(View view) {
        Intent intent = new Intent(endocrinonologo3.this,endo3.class);
